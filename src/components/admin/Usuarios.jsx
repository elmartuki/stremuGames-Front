...
export default function Usuarios() {
  ...
  useEffect(() => {
    if (usuariosData.length > 0 && listaUsuarios.length === 0) {
      setListaUsuarios(usuariosData);
    }
  }, [usuariosData, listaUsuarios.length]);

  const listadoFiltrado = listaUsuarios.filter((usuario) =>
    ...
    <>
      ...
      <section className="page_panel_admin">
        ...
        <section className="seccion_gestion">
          <div className="contenedor_tarjetas_usuarios">
                ...
                return (
                  <div className="tarjeta_desarrolladora" key={_id}>
                    <div className="tarjeta_desarrolladora_header">
                      ...
                      <span
                        className={`estado_etiqueta ${!activo ? "baneado" : "user"}`}
                      >
